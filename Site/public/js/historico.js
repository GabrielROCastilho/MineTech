...
// Quando a página carregar, busca os dados reais do servidor
window.onload = function() {
buscarDados(); // Chama a função para buscar os dados reais
};

// Função para buscar dados do servidor
function buscarDados() {
fetch('/medicoes/historico') // Faz a requisição para a rota do servidor
.then(response => {
if (!response.ok) {
...
.then(dados => {
colocarNaTabela(dados); // Coloca os dados na tabela
})
.catch(erro => {
